...
python /home/hasna/miccai24_challenges/topcow_challenge/src/quick_inference.py --model_bin_path /home/hasna/miccai24_challenges/topcow_challenge/nnunet_dir/datasetnnUNet_trained_models/Dataset807_TopCoWSegBinCTAMRA/nnUNetTrainerSkeletonRecall__nnUNetPlans__3d_fullres_ps --model_mul_path /home/hasna/miccai24_challenges/topcow_challenge/nnunet_dir/datasetnnUNet_trained_models/Dataset806_TopCoWSegCTAMRA/nnUNetTrainerSkeletonRecallBinDiceNoMirroring__nnUNetPlans__3d_fullres_ps --input_images /home/hasna/miccai24_challenges/topcow_challenge/nnunet_dir/dataset/nnUNet_raw/Dataset806_TopCoWSegCTAMRA/imagesTr --preds_folder /home/hasna/miccai24_challenges/topcow_challenge/nnunet_dir/datasetnnUNet_trained_models/Dataset806_TopCoWSegCTAMRA/nnUNetTrainerSkeletonRecallBinDiceNoMirroring__nnUNetPlans__3d_fullres_ps --save_folder /home/hasna/miccai24_challenges/topcow_challenge/evals/806_cta_skr_bindice_nomir_5folds_val-best --num_folds 5 --mod 'ct' --gpu 1
...
def main(args):
    ...
    for fold in range(args.num_folds):  # For each fold, initialize the corresponding model..
        ...
        for file in tqdm(natsorted(os.listdir(os.path.join(args.preds_folder, f'fold_{fold}/validation_final')))):
