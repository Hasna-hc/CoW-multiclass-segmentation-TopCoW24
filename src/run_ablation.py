...
python /home/hasna/miccai24_challenges/topcow_challenge_final/src/run_ablation.py --save_folder /home/hasna/miccai24_challenges/topcow_challenge_final/evals/mra_skr_bindice_nomir_5folds --num_folds 5 --min_vol 20
python /home/hasna/miccai24_challenges/topcow_challenge_final/src/run_ablation.py --save_folder /home/hasna/miccai24_challenges/topcow_challenge_final/evals/cta_skr_bindice_nomir_5folds --num_folds 5 --min_vol 20
...
def main(args):
    ...
    for fold in natsorted(os.listdir(os.path.join(args.save_folder, 'without_pp'))):
        ...
        for file in tqdm([file for file in natsorted(os.listdir(os.path.join(args.save_folder, 'without_pp', fold))) if file.endswith('.nii.gz')]):
            ...
            # pred_array_bin = nib.load(os.path.join(args.save_folder, 'bin', fold, file)).get_fdata()  #FIXME: For MRA
            pred_array_bin = nib.load(os.path.join(args.save_folder, 'bin', file.split('.')[0]+'_0000.nii.gz')).get_fdata()  # for CTA
