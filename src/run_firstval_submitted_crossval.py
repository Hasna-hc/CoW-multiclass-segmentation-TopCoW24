...
#TODO: THIS ONE!
python /home/hasna/miccai24_challenges/topcow_challenge_final/src/run_firstval_submitted_crossval.py --model_bin_path /home/hasna/miccai24_challenges/topcow_challenge/nnunet_dir/datasetnnUNet_trained_models/Dataset802_TopCoWSegBinMRA/nnUNetTrainerSkeletonRecall__nnUNetPlans__3d_fullres --model_mul_path /home/hasna/miccai24_challenges/topcow_challenge/nnunet_dir/datasetnnUNet_trained_models/Dataset801_TopCoWSegMRA/nnUNetTrainerSkeletonRecallBinDice__nnUNetPlans__3d_fullres_5folds --input_images /home/hasna/miccai24_challenges/topcow_challenge_final/nnunet_dir/dataset/nnUNet_raw/Dataset808_TopCoWSegMRA/imagesTr --preds_folder /home/hasna/miccai24_challenges/topcow_challenge/nnunet_dir/datasetnnUNet_trained_models/Dataset801_TopCoWSegMRA/nnUNetTrainerSkeletonRecallBinDice__nnUNetPlans__3d_fullres_5folds --save_folder /home/hasna/miccai24_challenges/topcow_challenge_final/evals/mra_skr_bindice_withmir_2folds --num_folds 2 --mod 'mr' --gpu 3
...
def main(args):
    ...
    predictor_bin = nnUNetPredictor(
        tile_step_size=0.5,  #FIXME: should've been 0.6
        use_gaussian=True,
        use_mirroring=True,
    ...
    for fold in range(args.num_folds):  # For each fold, initialize the corresponding model..
        ...
        for file in tqdm(natsorted(os.listdir(os.path.join(args.preds_folder, f'fold_{fold}/validation')))):
            ...
            if file.startswith(f'topcow_{args.mod}_'):
                ...
                pred_array = final_check_wrongly_submitted(cleaned_arr)  # Final checking: if a certain label has disconnected components, the smallest is either deleted (if it's not connected to anything) or takes the label of its neighbour (to ensure continuity)..
