...
def run():
    ...
    #FIXME: THIS ONE WAS THE ORIGINAL
    ...
    # pred_array = your_segmentation_algorithm(
    #     mr_path="/input/images/head-mr-angio", mr_input_array=input_head_mr_angiography, mra_props=props_mra,
    #     ct_path="/input/images/head-ct-angio", ct_input_array=input_head_ct_angiography, cta_props=props_cta,
    # )
