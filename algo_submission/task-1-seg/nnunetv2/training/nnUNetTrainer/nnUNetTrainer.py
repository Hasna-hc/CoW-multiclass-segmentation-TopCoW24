...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.initial_lr = 1e-3  #1e-2 #5e-3 #1e-2 #5e-3  #FIXME: was 1e-2
        self.weight_decay = 3e-5
        self.oversample_foreground_percent = 0.7  #FIXME was 0.33
        self.num_iterations_per_epoch = 250
        self.num_val_iterations_per_epoch = 50
        self.num_epochs = 500  #FIXME: 1000
        self.current_epoch = 0
        self.enable_deep_supervision = False #FIXME: wasTrue
        ...
        self.save_every = 10  #FIXME: was 50
    ...
    # def configure_optimizers(self):  #FIXME: This one from TriALS
    #     # optimizer = AdamW(self.network.parameters(), lr=self.initial_lr, weight_decay=self.weight_decay, eps=1e-5)
    #     base_optimizer = torch.optim.Adam  # AdamW  torch.optim.SGD
    #     optimizer = SAM(self.network.parameters(), base_optimizer, adaptive=False, lr=self.initial_lr)  #, momentum=0.9)  #, weight_decay=0.0005)
    #     # optimizer = SAM(self.network.parameters(), base_optimizer, lr=self.initial_lr)  #lr=1e-4
    #     # scheduler = CosineAnnealingLR(optimizer, T_max=self.num_epochs, eta_min=1e-6)
    #     scheduler = PolyLRScheduler(optimizer.base_optimizer, self.initial_lr, self.num_epochs)  #FIXME: using base_optimizer and not optimizer!!
    ...
    @staticmethod  #FIXME: here are the training data augmentation parameters..
    ...
    #         # del data
    #         l = self.loss(output, target)  # TODO: Here add the ROI mask..

    #     #TODO:  !!! Commented this part to add the SAM without grad_scaler.. !!!
    #     # if self.grad_scaler is not None:  #TODO: here adding the SAM optimizer
    #     #     self.grad_scaler.scale(l).backward()
    #     #     self.grad_scaler.unscale_(self.optimizer)
    #     #     torch.nn.utils.clip_grad_norm_(self.network.parameters(), 12)
    #     #     self.grad_scaler.step(self.optimizer)
    #     #     self.grad_scaler.update()
    #     # else:  #TODO: here adding the SAM optimizer
    #     #     l.backward()
    #     #     torch.nn.utils.clip_grad_norm_(self.network.parameters(), 12)
    #     #     self.optimizer.step()  #FIXME: add SAM here..
    ...
    #         # del data
    #         l = self.loss(output, target)  # TODO: Here add the ROI mask..
    #     disable_bn(self.network)
    #     l.backward()
    #     # torch.nn.utils.clip_grad_norm_(self.network.parameters(), 12)
    #     enable_bn(self.network)
    #     self.optimizer.second_step(zero_grad=True)

    #     self.lr_scheduler.step()  #FIXME:
    #     # !!! -------------------------------------------------------------- !!!
    ...
    #     # TODO: it was originally using the autocast part !!
    #     # with autocast(self.device.type, enabled=True) if self.device.type == 'cuda' else dummy_context():
    #     #     output = self.network(data)
    #     #     # del data
    #     #     l = self.loss(output, target)  # TODO: Here add the ROI mask..
    ...
    #     #TODO: Was originally using autocast here..
    #     # with autocast(self.device.type, enabled=True) if self.device.type == 'cuda' else dummy_context():
    #     #     output = self.network(data)
    #     #     # del data
    #     #     l = self.loss(output, target)  # TODO: Here add the ROI mask..
        
    #     #TODO: commenting the next lines to do in all in one line:
    #     # output = self.network(data)
    #     # l = self.loss(output, target)  # TODO: Here add the ROI mask..
    #     # l.backward()
    #     # with autocast(self.device.type, enabled=True) if self.device.type == 'cuda' else dummy_context():
    #     #     l_2 = self.loss(self.network(data), target)
    #     # l_2.backward()
    #     self.loss(self.network(data), target).backward()
