...
from dynamic_network_architectures.architectures.unet import PlainConvUNet, ResidualEncoderUNet  #FIXME:
...
class ExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
        ...
        self.UNet_class = PlainConvUNet  #PlainConvUNet #ResidualEncoderUNet # FIXME: Modified here
