...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.initial_lr = 5e-4 #1e-4  #FIXME: #1e-2
        ...
        self.num_patches = 1 #8  #FIXME: added this param to change the number of patches to extract per image
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            if not isfile(splits_file):
                ...
                splits = generate_crossval_split(all_keys_sorted, seed=12345, n_splits=3)  #FIXME:
